...
@section('title')
    Tambah Image Detail Unsur - GIS ISBI
@endsection
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Tambah Image Detail Unsur</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="col-lg-6">
                    <div class="card card-primary card-outline">
                        <div class="card-header ">
                            <h5 class="card-title">Form Tambah Image Detail Unsur</h5>
                        ...
                        <div class="card-body">
                            <form action="{{ route('detail.element.storeImage', $getDetailElement->id) }}" method="POST"
